...
load("/Users/dominikpeter/Google/datenanalyse/homework/stats/Aufgabe\ 5/StorchBabies.RData")
...
plot(StorchBabies$Storchenpaare, StorchBabies$Geburtenrate,
     xlab = "Storchenpaare", ylab = "Geburtenrate", col = "black")
abline(lm(Geburtenrate ~ Storchenpaare, data = StorchBabies))
